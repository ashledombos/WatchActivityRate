...
class DatabaseManager:
    ...
    # Obtient le répertoire du fichier en cours d'exécution
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))

    # Définit le chemin complet vers la base de données
    DB_NAME = os.path.join(BASE_DIR, '../votre_base_de_donnees.db')
